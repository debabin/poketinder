...
export const PokeballIcon = React.forwardRef<SVGSVGElement, PokeballIconProps>((props, ref) => (
  <svg ref={ref} viewBox='0 0 595.3 594.1' {...props}>
    <g>
      <g>
        <path
        ...
        />
        <path
          d='M347.1,297c-0.1-6.1-1.2-11.9-3.2-17.3
              c-7-18.8-25.1-32.1-46.3-32.1s-39.3,13.4-46.3,32.1c-2,5.4-3.1,11.2-3.1,17.3c0,0,0,0,0,0h0.1c0,0,0,0,0,0
              c0,6.1,1.1,11.9,3.1,17.3c7,18.8,25.1,32.1,46.3,32.1c21.2,0,39.3-13.4,46.3-32.1C346,309,347.1,303.1,347.1,297z'
          fill='#FFFFFF'
        />
        <path
